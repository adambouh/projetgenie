...
public class Respo{
   ...
   @GetMapping("/Respo/deletePerso/{login}")
    ...
    // Name of the }
    @GetMapping("/Respo/AppelDoffre={id}")
    public String AppelDoffre(@PathVariable("id") String id, HttpServletRequest request, Model model) {
        ...
        if (session != null) {
            ...
            if (user != null) {
                ...
                if (Objects.equals(user.getRole().toString(),"Responsable"))
                {
                    AppelDoffre AppelDoffre = appelDoffreControler.getAppelDoffreById(Long.parseLong(id));
                    session.setAttribute("appelDoffre", AppelDoffre);
                    if(AppelDoffre != null)
                    {
                        session.setAttribute("ressources",AppelDoffre.getRessources());
                        session.setAttribute("Ressources",ressourceControler.getAllRessources());

                        return "responsable de ressource/appelDoffre";}
                    return "redirect:/Respo/AppelDoffres";
                }
            } else {
        ...
        if (session != null) {
            ...
            if (user != null) {
                ...
                if (Objects.equals(user.getRole().toString(),"Responsable"))
                {
                    ...
                    for(User use :users){
                        if(fournisseurControler.getFournisseurById((use.getId().toString()))!=null)
                        Fournisseurs.add(fournisseurControler.getFournisseurById((use.getId().toString())));
                    }
                    session.setAttribute("Users", Fournisseurs);
                    return "responsable de ressource/Fournisseurs";}
            } else {
        ...
        if (session != null) {
            ...
            if (user != null) {
                ...
                if (Objects.equals(user.getRole().toString(),"Responsable"))
                {
                    ...
                    return "responsable de ressource/Ressources";}
            } else {
                return "redirect:login";
